...
namespace rbac
{
    ...
    enum RBACPermissions
    {
        ...
        RBAC_PERM_COMMAND_RELOAD_FIRELANDS_STRING = 704,
    ...
    public:
         ...
         *     FC_LOG_DEBUG("entities.player", "Failed to grant permission %u, already denied", permissionId);
         * @endcode
         */
         ...
         *     FC_LOG_DEBUG("entities.player", "Role Id %u does not exists", permissionId);
         * @endcode
         */
         ...
         *     FC_LOG_DEBUG("entities.player", "Permission %u succesfully removed", permissionId);
         * @endcode
         */
