...
void BattlefieldWG::OnBattleStart()
{
    ...
    if (GameObject* relic = SpawnGameObject(GO_WINTERGRASP_TITAN_S_RELIC, WintergraspRelicPos, WintergraspRelicRot))
    {
        ...
        FC_LOG_ERROR("bg.battlefield", "WG: Failed to spawn titan relic.");
...
uint8 BattlefieldWG::GetSpiritGraveyardId(uint32 areaId) const
{
    ...
    default:
        FC_LOG_ERROR("bg.battlefield", "BattlefieldWG::GetSpiritGraveyardId: Unexpected Area Id %u", areaId);
        break;
    }
...
void BfWGGameObjectBuilding::Destroyed()
{
    ...
    case BATTLEFIELD_WG_OBJECTTYPE_DOOR_LAST:
        ...
        if (_wg->GetRelic())
            ...
            FC_LOG_ERROR("bg.battlefield.wg", "Titan Relic not found.");
        break;
    default:
        break;
    }
