...
void BattlefieldMgr::InitBattlefield()
{
    ...
    {
        FC_LOG_INFO("bg.battlefield", "Battlefield: Wintergrasp init failed.");
        delete wg;
    }
    else
    {
        _battlefieldSet.push_back(wg);
        FC_LOG_INFO("bg.battlefield", "Battlefield: Wintergrasp successfully initiated.");
    }
    ...
    {
        FC_LOG_DEBUG("bg.battlefield", "Battlefield: Tol Barad init failed.");
        delete tb;
    }
    else
    {
        _battlefieldSet.push_back(tb);
        FC_LOG_DEBUG("bg.battlefield", "Battlefield: Tol Barad successfully initiated.");
    }
}
...
void BattlefieldMgr::HandlePlayerEnterZone(Player* player, uint32 zoneId)
{
    ...
    FC_LOG_DEBUG("bg.battlefield", "Player %u entered battlefield id %u", player->GetGUID().GetCounter(), bf->GetTypeId());
}
...
void BattlefieldMgr::HandlePlayerLeaveZone(Player* player, uint32 zoneId)
{
    ...
    FC_LOG_DEBUG("bg.battlefield", "Player %u left battlefield id %u", player->GetGUID().GetCounter(), itr->second->GetTypeId());
}
