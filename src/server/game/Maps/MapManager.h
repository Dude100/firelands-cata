...
#ifndef FIRELANDS_MAPMANAGER_H
#define FIRELANDS_MAPMANAGER_H
...
public:
    ...
    {
        return IsValidMAP(mapid, false) && Firelands::IsValidMapCoord(x, y);
    }

    static bool IsValidMapCoord(uint32 mapid, float x, float y, float z)
    {
        return IsValidMAP(mapid, false) && Firelands::IsValidMapCoord(x, y, z);
    }

    static bool IsValidMapCoord(uint32 mapid, float x, float y, float z, float o)
    {
        return IsValidMAP(mapid, false) && Firelands::IsValidMapCoord(x, y, z, o);
    }
