...
void WardenMac::Init(WorldSession* pClient, BigNumber* K)
{
    ...
    */
    ...
    FC_LOG_DEBUG("warden", "Server side warden for client %u initializing...", pClient->GetAccountId());
...
void WardenMac::HandleData(ByteBuffer& buff)
{
    ...
    {
        FC_LOG_DEBUG("warden", "Handle data failed: SHA1 hash is wrong!");
        //found = true;
    }
    ...
    {
        FC_LOG_DEBUG("warden", "Handle data failed: MD5 hash is wrong!");
        //found = true;
    }
