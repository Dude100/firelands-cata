...
{
    FC_LOG_DEBUG("network", "MSG_INSPECT_ARENA_TEAMS");

    ObjectGuid guid;
    recvData >> guid;
    FC_LOG_DEBUG("network", "Inspect Arena stats %s", guid.ToString().c_str());
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_QUERY");
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_ROSTER");
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_CREATE");
    ...
    {
        FC_LOG_ERROR("bg.arena", "Arena team create failed.");
        delete arenaTeam;
        return;
    }
...
{
    FC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_INVITE");
    ...
    FC_LOG_DEBUG("bg.battleground", "Player %s Invited %s to Join his ArenaTeam", GetPlayer()->GetName().c_str(), invitedName.c_str());
    ...
    FC_LOG_DEBUG("network", "WORLD: Sent SMSG_ARENA_TEAM_INVITE");
}

void WorldSession::HandleArenaTeamAcceptOpcode(WorldPacket& /*recvData*/)
{
    FC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_ACCEPT");                // empty opcode
...
{
    FC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_DECLINE");               // empty opcode
...
{
    FC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_LEAVE");
...
{
    FC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_DISBAND");
...
{
    FC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_REMOVE");
...
{
    FC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_LEADER");
