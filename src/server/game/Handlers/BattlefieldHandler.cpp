...
void WorldSession::HandleBfQueueInviteResponse(WorldPacket& recvData)
{
    ...
    FC_LOG_ERROR("misc", "HandleQueueInviteResponse: %s, accepted: %u", guid.ToString().c_str(), accepted);
...
void WorldSession::HandleBfEntryInviteResponse(WorldPacket& recvData)
{
    ...
    FC_LOG_ERROR("misc", "HandleBattlefieldInviteResponse: GUID: " UI64FMTD ", accepted: %u", uint64(guid), accepted);
...
void WorldSession::HandleBfExitRequest(WorldPacket& recvData)
{
    ...
    FC_LOG_ERROR("misc", "HandleBfExitRequest: GUID: " UI64FMTD, uint64(guid));
