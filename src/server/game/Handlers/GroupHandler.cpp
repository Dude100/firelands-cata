...
void WorldSession::HandlePartyInviteResponseOpcode(WorldPackets::Party::PartyInviteResponse& packet)
{
    ...
    if (packet.Accept)
    {
        ...
        {
            FC_LOG_ERROR("network", "HandleGroupAcceptOpcode: player %s(%d) tried to accept an invite to his own group", GetPlayer()->GetName().c_str(), GetPlayer()->GetGUID().GetCounter());
            return;
        }
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_CLEAR_RAID_MARKER");
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_UNINVITE_GUID");
    ...
    {
        FC_LOG_ERROR("network", "WorldSession::HandleGroupUninviteGuidOpcode: leader %s(%d) tried to uninvite himself from the group.",
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_UNINVITE");
    ...
    {
        FC_LOG_ERROR("network", "WorldSession::HandleGroupUninviteOpcode: leader %s(%d) tried to uninvite himself from the group.",
            GetPlayer()->GetName().c_str(), GetPlayer()->GetGUID().GetCounter());
        return;
    }
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_SET_LEADER");
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_SET_ROLES");
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_DISBAND");
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_LOOT_METHOD");
...
{
    FC_LOG_DEBUG("network", "WORLD: Received MSG_MINIMAP_PING");
    ...
    //FC_LOG_DEBUG("misc", "Received opcode MSG_MINIMAP_PING X: %f, Y: %f", x, y);
...
{
    FC_LOG_DEBUG("network", "WORLD: Received MSG_RAID_TARGET_UPDATE");
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_RAID_CONVERT");
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_CHANGE_SUB_GROUP");
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_SWAP_SUB_GROUP");
    std::string name1;
    std::string name2;
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_ASSISTANT_LEADER");
...
{
    FC_LOG_DEBUG("network", "WORLD: Received MSG_PARTY_ASSIGNMENT");
...
{
    FC_LOG_DEBUG("network", "WORLD: Received MSG_RAID_READY_CHECK");
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_REQUEST_PARTY_MEMBER_STATS");
    ObjectGuid Guid;
    recvData >> Guid;
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_OPT_OUT_OF_LOOT");
    ...
    {
        if (passOnLoot)
            FC_LOG_ERROR("network", "CMSG_OPT_OUT_OF_LOOT value<>0 for not-loaded character!");
        return;
    }
...
{
    FC_LOG_DEBUG("network", "WORLD: Received CMSG_ROLE_POLL_BEGIN");
