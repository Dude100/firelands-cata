...
void WorldSession::HandleAddFriendOpcode(WorldPacket& recvData)
{
    ...
    FC_LOG_DEBUG("network", "WorldSession::HandleAddFriendOpcode: %s asked to add friend: %s",
...
void WorldSession::HandleDelFriendOpcode(WorldPacket& recvData)
{
    ...
    recvData >> friendGuid;
    FC_LOG_DEBUG("network", "WorldSession::HandleDelFriendOpcode: %s", friendGuid.ToString().c_str());
...
void WorldSession::HandleAddIgnoreOpcode(WorldPacket& recvData)
{
    ...
    FC_LOG_DEBUG("network", "WorldSession::HandleAddIgnoreOpcode: %s asked to Ignore: %s",
...
void WorldSession::HandleDelIgnoreOpcode(WorldPacket& recvData)
{
    ...
    FC_LOG_DEBUG("network", "WorldSession::HandleDelIgnoreOpcode: %s", ignoreGuid.ToString().c_str());
...
void WorldSession::HandleSetContactNotesOpcode(WorldPacket& recvData)
{
    ...
    FC_LOG_DEBUG("network", "WorldSession::HandleSetContactNotesOpcode: Contact: %s, Notes: %s", guid.ToString().c_str(), note.c_str());
