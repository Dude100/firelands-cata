...
public:
    ...
    struct npc_barnesAI : public EscortAI
    {
        ...
        {
            FC_LOG_DEBUG("scripts", "Barnes Opera Event - Introduction complete - preparing encounter %d", m_uiEventId);
            uint8 index = 0;
            uint8 count = 0;
        ...
        bool GossipSelect(Player* player, uint32 /*menuId*/, uint32 gossipListId) override
        {
            ...
            case GOSSIP_ACTION_INFO_DEF + 3:
                ...
                FC_LOG_DEBUG("scripts", "player (%s) manually set Opera event to EVENT_OZ", player->GetGUID().ToString().c_str());
                break;
            case GOSSIP_ACTION_INFO_DEF + 4:
                CloseGossipMenuFor(player);
                m_uiEventId = EVENT_HOOD;
                FC_LOG_DEBUG("scripts", "player (%s) manually set Opera event to EVENT_HOOD", player->GetGUID().ToString().c_str());
                break;
            case GOSSIP_ACTION_INFO_DEF + 5:
                CloseGossipMenuFor(player);
                m_uiEventId = EVENT_RAJ;
                FC_LOG_DEBUG("scripts", "player (%s) manually set Opera event to EVENT_RAJ", player->GetGUID().ToString().c_str());
                break;
            }
