...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        static std::vector<ChatCommand> reloadCommandTable =
        {
            ...
            { "firelands_string",                rbac::RBAC_PERM_COMMAND_RELOAD_FIRELANDS_STRING,                   true,  &HandleReloadFirelandsStringCommand,              "" },
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Loot Tables...");
        LoadLootTables();
    ...
    static bool HandleReloadAllQuestCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        FC_LOG_INFO("misc", "Re-Loading Quests Relations...");
    ...
    static bool HandleReloadAllScriptsCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        FC_LOG_INFO("misc", "Re-Loading Scripts...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading config settings...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Access Requirement definitions...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Additional Achievement Criteria Data...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Achievement Reward Data...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Tavern Area Triggers...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading AreaTrigger teleport definitions...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Autobroadcasts...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Battleground Templates...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Broadcast texts...");
    ...
    static bool HandleReloadOnKillRewardCommand(ChatHandler* handler, const char* /*args*/) {
        FC_LOG_INFO("misc", "Re-Loading creature reward definitions...");
    ...
    {
        FC_LOG_INFO("misc", "Reloading creature summon groups...");
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, char const* args)
    {
        ...
        for (Tokenizer::const_iterator itr = entries.begin(); itr != entries.end(); ++itr)
        {
            ...
            FC_LOG_INFO("misc", "Reloading creature template entry %u", entry);
    ...
    {
        FC_LOG_INFO("misc", "Loading Quests Relations... (`creature_queststarter`)");
    ...
    {
        FC_LOG_INFO("misc", "Loading Linked Respawns... (`creature_linked_respawn`)");
    ...
    {
        FC_LOG_INFO("misc", "Loading Quests Relations... (`creature_questender`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading `gossip_menu` Table!");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading `gossip_menu_option` Table!");
    ...
    {
        FC_LOG_INFO("misc", "Loading Quests Relations... (`gameobject_queststarter`)");
    ...
    {
        FC_LOG_INFO("misc", "Loading Quests Relations... (`gameobject_questender`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Quest Area Triggers...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Quest Greeting ...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Quest Greeting locales...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Quest Templates...");
        sObjectMgr->LoadQuests();
        sObjectMgr->InitializeQueriesData(QUERY_DATA_QUESTS);
        handler->SendGlobalGMSysMessage("DB table `quest_template` (quest definitions) reloaded.");

        /// dependent also from `gameobject` but this table not reloaded anyway
        FC_LOG_INFO("misc", "Re-Loading GameObjects for quests...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Loot Tables... (`creature_loot_template`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Creature movement overrides...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Loot Tables... (`disenchant_loot_template`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Loot Tables... (`fishing_loot_template`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Loot Tables... (`gameobject_loot_template`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Loot Tables... (`item_loot_template`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Loot Tables... (`milling_loot_template`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Loot Tables... (`pickpocketing_loot_template`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Loot Tables... (`prospecting_loot_template`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Loot Tables... (`mail_loot_template`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Loot Tables... (`reference_loot_template`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Loot Tables... (`skinning_loot_template`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Loot Tables... (`spell_loot_template`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading firelands_string Table!");
    ...
    static bool HandleReloadWardenactionCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        FC_LOG_INFO("misc", "Re-Loading warden_action Table!");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading `trainer` Table!");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading `npc_vendor` Table!");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading `points_of_interest` Table!");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Quest POI ...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading `npc_spellclick_spells` Table!");
    ...
    {
        FC_LOG_INFO("misc", "Loading ReservedNames... (`reserved_name`)");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading `reputation_reward_rate` Table!");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading `reputation_spillover_template` Table!");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Skill Discovery Table...");
    ...
    { // latched onto HandleReloadSkillExtraItemTemplateCommand as it's part of that table group (and i don't want to chance all the command IDs)
        FC_LOG_INFO("misc", "Re-Loading Skill Perfection Data Table...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Skill Extra Item Table...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Skill Fishing base level requirements...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading SpellArea Data...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Spell Required Data... ");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Spell Groups...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Spell Learn Spells...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Spell Linked Spells...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Spell Proc conditions and data...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Spell Bonus Data...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Spell target coordinates...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Aggro Spells Definitions...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Spell Group Stack Rules...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Spell pet auras...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Page Text...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Item Random Enchantments Table...");
    ...
    static bool HandleReloadEventScriptsCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (*args != 'a')
            FC_LOG_INFO("misc", "Re-Loading Scripts from `event_scripts`...");
    ...
    static bool HandleReloadWpScriptsCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (*args != 'a')
            FC_LOG_INFO("misc", "Re-Loading Scripts from `waypoint_scripts`...");
    ...
    {
        if (*args != 'a')
            FC_LOG_INFO("misc", "Re-Loading Waypoints data from 'waypoints_data'");
    ...
    static bool HandleReloadSpellScriptsCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (*args != 'a')
            FC_LOG_INFO("misc", "Re-Loading Scripts from `spell_scripts`...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Graveyard-zone links...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Game Tele coordinates...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading disables table...");
        DisableMgr::LoadDisables();
        FC_LOG_INFO("misc", "Checking quest disables...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Achievement Reward Data Locale...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading lfg dungeon rewards...");
        sLFGMgr->LoadRewards();
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Creature Template Locale...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Creature Texts Locale...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Gameobject Template Locale... ");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Gossip Menu Option Locale... ");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading NPC Text Locale... ");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Page Text Locale... ");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Points Of Interest Locale... ");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Quest Template Locale... ");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Player level dependent mail rewards...");
    ...
    static bool HandleReloadAuctionsCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        FC_LOG_INFO("misc", "Re-Loading Auctions...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Conditions...");
        sConditionMgr->LoadConditions(true);
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Creature Texts...");
    ...
    {
        FC_LOG_INFO("misc", "Re-Loading Smart Scripts...");
    ...
    {
        FC_LOG_INFO("misc", "Reloading vehicle_accessory table...");
    ...
    {
        FC_LOG_INFO("misc", "Reloading vehicle_template_accessory table...");
    ...
    {
        FC_LOG_INFO("misc", "Reloading RBAC tables...");
