...
public:
    ...
    static bool HandleArenaDisbandCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (handler->GetSession())
            FC_LOG_DEBUG("bg.arena", "GameMaster: %s [GUID: %u] disbanded arena team type: %u [Id: %u].",
                handler->GetSession()->GetPlayer()->GetName().c_str(), handler->GetSession()->GetPlayer()->GetGUID().GetCounter(), arena->GetType(), teamId);
        else
            FC_LOG_DEBUG("bg.arena", "Console: disbanded arena team type: %u [Id: %u].", arena->GetType(), teamId);
    ...
    static bool HandleArenaRenameCommand(ChatHandler* handler, char const* _args)
    {
        ...
        if (handler->GetSession())
            FC_LOG_DEBUG("bg.arena", "GameMaster: %s [GUID: %u] rename arena team \"%s\"[Id: %u] to \"%s\"",
            ...
            FC_LOG_DEBUG("bg.arena", "Console: rename arena team \"%s\"[Id: %u] to \"%s\"", oldArenaStr, arena->GetId(), newArenaStr);
    ...
    static bool HandleArenaCaptainCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (handler->GetSession())
            FC_LOG_DEBUG("bg.arena", "GameMaster: %s [GUID: %u] promoted player: %s [GUID: %u] to leader of arena team \"%s\"[Id: %u]",
            ...
            FC_LOG_DEBUG("bg.arena", "Console: promoted player: %s [GUID: %u] to leader of arena team \"%s\"[Id: %u]",
