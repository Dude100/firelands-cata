...
#define FC_LOG_TRACE(filterType__, ...) \
    FC_LOG_MESSAGE_BODY(filterType__, LOG_LEVEL_TRACE, __VA_ARGS__)

#define FC_LOG_DEBUG(filterType__, ...) \
    FC_LOG_MESSAGE_BODY(filterType__, LOG_LEVEL_DEBUG, __VA_ARGS__)

#define FC_LOG_INFO(filterType__, ...)  \
    FC_LOG_MESSAGE_BODY(filterType__, LOG_LEVEL_INFO, __VA_ARGS__)

#define FC_LOG_WARN(filterType__, ...)  \
    FC_LOG_MESSAGE_BODY(filterType__, LOG_LEVEL_WARN, __VA_ARGS__)

#define FC_LOG_ERROR(filterType__, ...) \
    FC_LOG_MESSAGE_BODY(filterType__, LOG_LEVEL_ERROR, __VA_ARGS__)

#define FC_LOG_FATAL(filterType__, ...) \
    FC_LOG_MESSAGE_BODY(filterType__, LOG_LEVEL_FATAL, __VA_ARGS__)
